  ...
  class Wp_vim
    ...
    def initialize
      begin
        ...
        @blog.proxy = @proxy = XMLRPC::Client::Proxy.new(@proxy_addr)
        VIM.command("echo \"Something\"")
   ...
   def get_personal_data  
      ...
      @passwd = "asdf;lkj" # insert your password here
      @site = "arun.chagantys.org" # insert your blog url here, but do not use http://
      @xml = "/blog/xmlrpc.php" # change if necessary
      @port = 80 # change if necessary
      @proxy_addr = "http://localhost:5050"
      @blog_id = 0
      @user =  1
    end
